    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{ url('/') }}" class="navbar-brand"><b>Maniquie</b> CE</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Planes de pago<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="{{ route('conceptocobro.index') }}">Conceptos de cobro</a></li>
                <li><a href="{{ route('planpago.index') }}">Planes de pago</a></li>
                <li><a href="{{ route('becas.index') }}">Conceptos de Becas</a></li>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer" style="background-color:gray ;">                  
                  <div class="pull-right">
                    <a href="#" class="btn btn-default btn-flat" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Cerrar sesion</a>
                  </div>
            ...
            @guest
            @else
              <li class="container2"><a href="#" class="btn btn-primary btn-xs" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Cerrar sesion</a></li>
            @endguest            
          </ul>
        </div>
        <!-- /.navbar-custom-menu -->
