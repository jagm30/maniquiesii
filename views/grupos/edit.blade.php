            ...
            <!-- form start -->            
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="cupo_maximo" name="cupo_maximo" required placeholder="cupo maximo del grupo" value="{{ $grupo->cupo_maximo }}">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Diferenciador de grupo</label>
