                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="codigo" name="codigo" value="{{ $conceptocobro->codigo }}" required placeholder="Codigo">
                    </div>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Descripcion</label>
                      <input type="text" class="form-control" id="descripcion" name="descripcion" value="{{ $conceptocobro->descripcion }}" required placeholder="Descripcion">
                    </div>
                  </div>
                </div>
                <div class="row">
