        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Asignacion de cuentas por cobrar</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->            
              <div class="box-body">
        ...
        <div class="col-md-4">
          <div class="box box-solid">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Seleccione los elementos:</h3>
            </div>
            <!-- /.box-header -->
      ...
      $.ajax({
       ...
       success:function(html){
          ...
          if(id=="nivel"){
            ...
            {
              $("#opcion_asignacion2").append('<option value="' + html.data[i].id + '">' + html.data[i].clave_identificador + '</option>');
            }
          }
          if(id=="grupo"){
            ...
            {
              $("#opcion_asignacion2").append('<option value=' + html.data[j].id_grupo+ '>' + html.data[j].grado_semestre +' '+html.data[j].diferenciador_grupo + '</option>');
            }  
          }
          if(id=="alumno"){
            $("#contenedorOpcAsig").empty();
            ...
            {
              $("#opcion_asignacion2").append('<option value=' + html.data[k].id + '>' + html.data[k].apaterno +' </option>');
            }  
          }
       }
      })
      ...
      $.ajax({
       ...
       success:function(html){
          ...
          if(id=="nivel"){  
            for (var i = 0; i < html.data.length; i++) 
            {
              $("#contenedorOpcAsig").append('<p class="text-green"> <img src="/images/grupo.png" alt="Avatar" style="width:30px"> <input type="checkbox" checked name="opciones[]" value="'+html.data[i].id_grupo+'"> ' + html.data[i].grado_semestre +' '+ html.data[i].diferenciador_grupo  +' <br/></p>');              
            }
          }
          if(id=="alumno"){  
            for (var i = 0; i < html.data.length; i++) 
