        ...
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control" name="anio_corresponde" id="anio_corresponde">
            </div>
           </div> 
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control" name="no_parcialidad" id="no_parcialidad">
            </div>
           </div>  
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="date" class="form-control" name="periodo_vencimiento" id="periodo_vencimiento">
            </div>
           </div> 
           <div class="form-group">
