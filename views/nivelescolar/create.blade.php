                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="acuerdo_incorporacion" name="acuerdo_incorporacion" required placeholder="Acuerdo / Incoporacion">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="denominacion_grado" name="denominacion_grado" required placeholder="Descripcion del nivel">
                    </div>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group">
