                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="acuerdo_incorporacion" name="acuerdo_incorporacion" required value="{{ $nivelescolar->acuerdo_incorporacion }}" placeholder="Acuerdo / Incoporacion">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Fecha de incorporacion</label>
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="denominacion_grado" name="denominacion_grado" required value="{{ $nivelescolar->denominacion_grado }}" placeholder="Zona escolar">
                    </div>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group">
