                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="status" name="status" required  value="{{ $alumno->status }}">
                        ...
                        <option {{($alumno->status== 'egresado') ? 'selected' : ''}}>egresado</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-xs-6">
              ...
              <table class="table table-bordered" id="tbcuentas">
                <thead>
                  <b><tr>                  
                    ...
                    <th style="width: 50px">Fecha de vencimiento</th>
                ...
                <tbody>                 
                  @foreach($planespago as $planpago)
                    ...
                    @foreach($cuentaasignadas as $cuentaasignada)
                      ...
                      <?php 
                        $originalDate2 = $cuentaasignada->periodo_vencimiento;
                        $fecha_vencimiento = date("d-m-Y", strtotime($originalDate2));
                      ?>
                      <tr>                        
