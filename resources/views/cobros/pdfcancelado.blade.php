  ...
  ?>
     ...
     <div id="watermark">
        ...
        <main> 
            ...
            <p style="font:50pt; font-family: sans-serif ; color: red; position: fixed; left: 20mm; top: 80mm; right: 0px;   color:red;">C A N C E L A D O</p>
            <p style="font:10pt; font-family: sans-serif ; color: red; position: fixed; left: 20mm; top: 80mm; right: 0px;   color:red;">{{$cobroi->updated_at}}</p>
            <p style="font:10pt; font-family: sans-serif ; color: red; position: fixed; left: 20mm; top: 98mm; right: 0px;   color:red;">Motivo: {{$cobro_cancelado->motivo}}</p>
